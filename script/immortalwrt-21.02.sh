...
#mv $GITHUB_WORKSPACE/patch/immortalwrt-21.02/zz-ipq40xx package/base-files/files/etc/uci-defaults/zz-diy
mv $GITHUB_WORKSPACE/patch/immortalwrt-21.02/zz-bcm53xx package/base-files/files/etc/uci-defaults/zz-diy
